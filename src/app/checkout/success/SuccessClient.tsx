    ...
    <div className="min-h-screen bg-[#061a33] text-white">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="bg-white text-black rounded-2xl p-8 shadow-xl">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h1 className="text-2xl font-bold mb-1">¡Pedido recibido!</h1>

              <p className="text-gray-700">
                Gracias por comprar en <b>USAShopBox</b>. Ya tenemos tu solicitud
                y empezamos a procesarla.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-gray-50 rounded-xl p-4 border">
              ...
              <p className="text-lg font-bold">Pendiente de pago</p>
            </div>
          </div>
          ...
          <div className="mt-7 space-y-3 text-gray-800">
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>Te vamos a avisar por email cuando confirmemos el pago.</li>
              <li>
                Una vez confirmado, compramos el producto en USA y lo enviamos a
                tu domicilio en Argentina.
              </li>
              <li>Podés seguir el estado de tu orden desde tu panel.</li>
            </ul>
          </div>
          ...
          {/* ID técnico chiquito */}
          {orderId && (
            <p className="mt-6 text-xs text-gray-500">ID interno: {orderId}</p>
          )}
        </div>
        ...
        <div className="text-center text-white/80 mt-8">
          <p className="text-sm">
            Si tenés alguna duda, escribinos cuando quieras. Estamos para
